...
export default {
  ...
  methods: {
    async fetchTrendData() {
      ...
      this.error = null;
      try {
        const res = await fetch("https://script.google.com/macros/s/AKfycbxDH3TQoe2iR_LfIOhWPQBi-Odh5Nr-wK0UbvqDW1xjnhDHUrRTj2IjzkXPad48Rvxl/exec/api/trend", {redirect: "follow",});
